...
public class AttemptService {
    ...
    @Autowired
    private AttemptService(PaperRepo paperRepo, AttemptRepo attemptRepo, TermsAndConditionsDAO termsDao) { //NOSONAR This constructor is private to enforce use of Autowired
