...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale) VALUES (1, 1,'You have been asked to develop a function called IsEven that return true if a given integer parameter is even, or false if odd. Write this function below.', 5);
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (15, 1,'Which classes can access a variable declared as private? </br> A) All classes. </br> B) Within the body of the class that encloses the declaration. </br> C)Inheriting sub classes. </br> D) Classes in the same namespace.', 1, 'B');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (16, 1,'Which classes can access a variable with no access modifier? </br> A) All classes.</br> B) Within the body of the class that encloses the declaration.</br> C) Inheriting sub classes</br> D) Classes in the same namespace.', 1, 'B');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (18, 1,'Which of the following C# objects is most suitable for storing general key/value pairs? </br>A) Dictionary</br>B) List</br>C) HashSet</br>D) IEnumerable', 1, 'A');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (32, 1,'Correct answer is B A) Some text <br/>B) Some text <br/>C) Some text <br/>', 1, 'B');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (33, 1,'Correct answer is A A) Some text <br/>B) Some text <br/>C) Some text <br/>', 1, 'A');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (34, 1,'Correct answer is C A) Some text <br/>B) Some text <br/>C) Some text <br/>', 1, 'C');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (35, 1,'Correct answer is A A) Some text <br/>B) Some text <br/>C) Some text <br/>', 1, 'A');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (36, 1,'Correct answer are A,B A) Some text <br/>B) Some text <br/>C) Some text <br/>', 1, 'A,B');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (37, 1,'Correct answer are A,B,C A) Some text <br/>B) Some text <br/>C) Some text <br/>', 1, 'A,B,C');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (38, 1,'Correct answer are A,B,C A) Some text <br/>B) Some text <br/>C) Some text <br/>', 1, 'A,B,C');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (39, 1,'Correct answer is B A) Some text <br/>B) Some text <br/>C) Some text <br/>', 1, 'B');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (40, 1,'Correct answer is A A) Some text <br/>B) Some text <br/>C) Some text <br/>', 1, 'A');
...
INSERT INTO QuestionVersion(paperId, versionNumber, text, timeScale, correctAnswer) VALUES (41, 1,'Correct answer is C A) Some text <br/>B) Some text <br/>C) Some text <br/>', 1, 'C');
