...
INSERT INTO `QuestionVersionEntry` VALUES (1,1,1,1,1),(1,1,1,2,2),(1,1,1,3,3),(1,1,1,4,4),(1,1,1,5,5),(1,1,1,6,6),(1,1,1,7,7),(1,1,1,8,8),(1,2,1,9,1),(1,2,1,10,2),(1,2,1,11,3),(1,3,1,12,1),(1,3,1,13,2),(1,4,1,14,1),(1,4,1,15,2),(1,5,1,16,1),(1,5,1,17,2),(2,1,2,1,1),(2,1,2,2,2),(2,1,2,3,3),(2,1,2,4,4),(2,1,2,5,5),(2,1,2,6,6),(2,1,2,7,7),(2,1,2,8,8),(2,2,2,9,1),(2,2,2,10,2),(2,2,2,11,3),(2,3,2,12,1),(2,3,2,13,2),(2,4,2,14,1),(2,4,2,15,2),(2,5,2,16,2),(2,5,2,17,1),(2,6,2,18,1),(2,6,2,19,2),(2,6,2,20,3),(2,6,2,21,4),(2,6,2,22,5),(2,6,2,23,6),(2,6,2,24,7),(2,6,2,25,8),(2,6,2,26,9),(2,6,2,27,10);
...
INSERT INTO `TestPaper` VALUES (1,'Interview Test-Graduate (C#)',60),(2,'Sample Multiple Choice Auto-Marking Test',20);
...
INSERT INTO `TestPaperSection` VALUES (1,'C# Language'),(2,'Problem Solving'),(3,'Architecture and Theory'),(4,'Written Communication'),(5,'Test Case Design'),(6,'Multiple Choice');
...
INSERT INTO `TestPaperSectionVersion` VALUES (1,1,8,NULL,22),(1,2,8,'<p>Sample instructions text.</p>',22),(2,1,2,NULL,10),(2,2,2,'<p>Sample instructions text,</p>',10),(3,1,1,NULL,10),(3,2,1,'<p>Sample instructions text.</p>',10),(4,1,1,NULL,8),(4,2,1,'<p>Sample instructions text</p>',8),(5,1,1,NULL,10),(5,2,1,'<p>Sample section instructions text.</p>',10),(6,1,10,NULL,20),(6,2,10,'<p>Sample section instructions</p>',20),(6,3,10,'<p>Sample section </p>',20);
...
INSERT INTO `TestPaperSectionVersionEntry` VALUES (2,1,1,1,1),(2,2,1,1,2),(2,3,1,1,3),(2,4,1,1,4),(2,5,1,1,5),(3,6,1,2,1);
...
-- Dump completed on 2017-04-27  1:20:34
