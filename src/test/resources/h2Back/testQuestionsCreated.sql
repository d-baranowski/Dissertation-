;             
CREATE USER IF NOT EXISTS SA SALT 'cbfd617a9a78b291' HASH 'aae06fd44b0623df9d9273a885c0112e7c16bb86fea3855e73b3afbf4ccd4e28' ADMIN;           
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_89DC0C70_58A6_453F_AEA7_5074C71CC195 START WITH 4 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_6541E489_B7C9_4C4F_9C85_540C9FD03FAD START WITH 51 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_ECAE35C6_4BBE_4065_A490_28504DE648EF START WITH 54 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_9B695A60_4C1F_42A3_8B73_F27BBDDAF349 START WITH 2 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_5617ECD6_6300_4CA1_8BFC_1D996750B77A START WITH 2 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_637568E0_AC6A_4C0B_9DCE_1EEC61C112C4 START WITH 8 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_40D39A7E_EA30_4566_84DD_67EFD0B0E8CF START WITH 1 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_81022EC1_7EFE_4AA8_878D_EC665DBC4DDD START WITH 1 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_FD0F6AEA_30CC_421F_A602_733D96A3FCF0 START WITH 6 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_487A8331_3929_4E27_9D9C_235FEA7FDCEF START WITH 1 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_88B6DA00_C7F5_44CC_B770_48FBA18C76D5 START WITH 6 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_DD618AFF_0B59_4524_ACEB_0565694FAB71 START WITH 11 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_78AA6136_52F0_4E60_A85C_689BF90056FD START WITH 1 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_892D48FB_8E28_40F2_BD58_D9A8485128D0 START WITH 2 BELONGS_TO_TABLE;    
...
CREATE MEMORY TABLE PUBLIC.MODULE(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_DD618AFF_0B59_4524_ACEB_0565694FAB71) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_DD618AFF_0B59_4524_ACEB_0565694FAB71,
...
CREATE MEMORY TABLE PUBLIC.MODULELEADER(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_FD0F6AEA_30CC_421F_A602_733D96A3FCF0) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_FD0F6AEA_30CC_421F_A602_733D96A3FCF0,
    USERID VARCHAR(36) NOT NULL,
...
CREATE MEMORY TABLE PUBLIC.TESTDAY(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_5617ECD6_6300_4CA1_8BFC_1D996750B77A) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_5617ECD6_6300_4CA1_8BFC_1D996750B77A,
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.TESTDAY; 
...
CREATE MEMORY TABLE PUBLIC.CANDIDATE(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_88B6DA00_C7F5_44CC_B770_48FBA18C76D5) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_88B6DA00_C7F5_44CC_B770_48FBA18C76D5,
...
CREATE MEMORY TABLE PUBLIC.TESTPAPER(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_89DC0C70_58A6_453F_AEA7_5074C71CC195) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_89DC0C70_58A6_453F_AEA7_5074C71CC195,
    REFERENCENAME VARCHAR(150) NOT NULL,
    TIMEALLOWED INT
);     
ALTER TABLE PUBLIC.TESTPAPER ADD CONSTRAINT PUBLIC.CONSTRAINT_6 PRIMARY KEY(_ID);             
-- 3 +/- SELECT COUNT(*) FROM PUBLIC.TESTPAPER;               
...
-- 3 +/- SELECT COUNT(*) FROM PUBLIC.TESTPAPERVERSION;        
...
CREATE MEMORY TABLE PUBLIC.TESTPAPERSECTION(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_637568E0_AC6A_4C0B_9DCE_1EEC61C112C4) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_637568E0_AC6A_4C0B_9DCE_1EEC61C112C4,
    REFERENCENAME VARCHAR(150)
);             
ALTER TABLE PUBLIC.TESTPAPERSECTION ADD CONSTRAINT PUBLIC.CONSTRAINT_23 PRIMARY KEY(_ID);     
-- 7 +/- SELECT COUNT(*) FROM PUBLIC.TESTPAPERSECTION;        
...
-- 7 +/- SELECT COUNT(*) FROM PUBLIC.TESTPAPERSECTIONVERSION; 
...
-- 7 +/- SELECT COUNT(*) FROM PUBLIC.TESTPAPERSECTIONVERSIONENTRY;            
...
CREATE MEMORY TABLE PUBLIC.QUESTION(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_ECAE35C6_4BBE_4065_A490_28504DE648EF) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_ECAE35C6_4BBE_4065_A490_28504DE648EF,
...
(1, 44, '<p><em><u>This question was designed by selenium</u></em></p>', '', '<p>Sample marking guide.</p>', 1),
(1, 45, '<p><em><u>This question was designed by selenium</u></em></p>', '', '<p>Sample marking guide.</p>', 1),
(1, 46, '<p><em><u>This question was designed by selenium</u></em></p>', '', '<p>Sample marking guide.</p>', 1),
(1, 47, '<p><em><u>This question was designed by selenium</u></em></p>', '', '<p>Sample marking guide.</p>', 10),
(1, 48, '<p><em><u>This questions will test simple answer matching</u></em></p>', '[]', '<p>Correct answer is Java, but C# gives one mark</p>', 10),
(1, 49, '<p><em><u>This questions will test white space collapsing</u></em></p>', '[]', '<p>Correct answer is Hello World, but Hi Planet gives one mark</p>', 10),
(1, 50, '<p><em><u>This questions will test alternative punctuation</u></em></p>', '[]', '<p>Correct answer is S.W.A.T, but F.E.A.R gives one mark</p>', 10),
(1, 51, '<p><em><u>This questions will test case insensitivity</u></em></p>', '[]', '<p>Correct answer is GoOGle but TwiTtEr gives one mark</p>', 10),
(1, 52, '<p><em><u>This questions will test all options</u></em></p>', '[]', STRINGDECODE('<p>Correct answer is F.E.A.R iS A GoOD \u00a0 Game but Random gives one mark</p>'), 10),
(1, 53, '<p><em><u>This questions will test custom regex</u></em></p>', '[]', '<p>Correct answer is any valid email but cheatSheet gives one mark</p>', 10);      
CREATE MEMORY TABLE PUBLIC.QUESTIONVERSIONASSET(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_487A8331_3929_4E27_9D9C_235FEA7FDCEF) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_487A8331_3929_4E27_9D9C_235FEA7FDCEF,
...
-- 28 +/- SELECT COUNT(*) FROM PUBLIC.QUESTIONVERSIONENTRY;   
...
CREATE MEMORY TABLE PUBLIC.TERMSANDCONDITIONS(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_9B695A60_4C1F_42A3_8B73_F27BBDDAF349) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_9B695A60_4C1F_42A3_8B73_F27BBDDAF349,
...
CREATE MEMORY TABLE PUBLIC.EXAM(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_892D48FB_8E28_40F2_BD58_D9A8485128D0) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_892D48FB_8E28_40F2_BD58_D9A8485128D0,
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.EXAM;    
...
CREATE MEMORY TABLE PUBLIC.TESTDAYENTRY(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_78AA6136_52F0_4E60_A85C_689BF90056FD) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_78AA6136_52F0_4E60_A85C_689BF90056FD,
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TESTDAYENTRY;            
CREATE MEMORY TABLE PUBLIC.CANDIDATEMODULE(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_6541E489_B7C9_4C4F_9C85_540C9FD03FAD) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_6541E489_B7C9_4C4F_9C85_540C9FD03FAD,
    MODULEID INT,
    CANDIDATEID INT
);      
...
CREATE MEMORY TABLE PUBLIC.MARK(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_81022EC1_7EFE_4AA8_878D_EC665DBC4DDD) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_81022EC1_7EFE_4AA8_878D_EC665DBC4DDD,
    MARKERID VARCHAR(36),
...
CREATE MEMORY TABLE PUBLIC.ANSWERASSET(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_40D39A7E_EA30_4566_84DD_67EFD0B0E8CF) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_40D39A7E_EA30_4566_84DD_67EFD0B0E8CF,
    QUESTIONID INT NOT NULL,
    QUESTIONVERSIONNUMBER INT NOT NULL,
    TESTDAYENTRYID INT NOT NULL,
    REFERENCENAME VARCHAR(150),
