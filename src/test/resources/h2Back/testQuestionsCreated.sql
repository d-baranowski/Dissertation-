;             
CREATE USER IF NOT EXISTS SA SALT 'df860c55a2f5728d' HASH 'f706a5a2706d45a67e0b27bb7a5173d4dd1826790afc5ff1748499219bdb5530' ADMIN;           
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_03037EB0_41F9_483E_B1C7_EBAC8320E480 START WITH 6 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_356D42DC_0279_4D80_9870_37E8B8D559FE START WITH 1 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_F813B2FE_3495_4423_8C77_38F6E7FA5F3F START WITH 1 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A86B94F8_AC5B_407C_B296_E32A5D56C9EE START WITH 6 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_644AC045_2539_4620_89B5_84BB1CD096E4 START WITH 51 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_8B39580F_67AB_4929_B916_3BA141DC455C START WITH 1 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_0C35A0AE_4D7B_48B9_9FC7_5B20C8BA07FC START WITH 8 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_B012A917_8F5D_431E_AFEF_22651AAF595E START WITH 2 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_3FA2051E_2228_441D_A771_9CF18D23C046 START WITH 2 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_8E936F15_72BC_4135_A28B_E6A5953DADE6 START WITH 1 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_25EBE862_8812_4F07_B329_2B0CB08926F7 START WITH 4 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_0425E657_55B5_4534_9CFE_85A44F68D380 START WITH 54 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_6945401B_6492_4461_BAA8_1D6C1A32D112 START WITH 11 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_0372C160_CDAC_4333_8909_DD5D8A48712E START WITH 2 BELONGS_TO_TABLE;    
...
CREATE MEMORY TABLE PUBLIC.MODULE(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_6945401B_6492_4461_BAA8_1D6C1A32D112) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_6945401B_6492_4461_BAA8_1D6C1A32D112,
...
CREATE MEMORY TABLE PUBLIC.MODULELEADER(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_03037EB0_41F9_483E_B1C7_EBAC8320E480) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_03037EB0_41F9_483E_B1C7_EBAC8320E480,
    USERID VARCHAR(36) NOT NULL,
...
CREATE MEMORY TABLE PUBLIC.TESTDAY(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_B012A917_8F5D_431E_AFEF_22651AAF595E) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_B012A917_8F5D_431E_AFEF_22651AAF595E,
...
CREATE MEMORY TABLE PUBLIC.CANDIDATE(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_A86B94F8_AC5B_407C_B296_E32A5D56C9EE) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A86B94F8_AC5B_407C_B296_E32A5D56C9EE,
    NAME VARCHAR(50) NOT NULL,
    SURNAME VARCHAR(50) NOT NULL,
...
CREATE MEMORY TABLE PUBLIC.TESTPAPER(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_25EBE862_8812_4F07_B329_2B0CB08926F7) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_25EBE862_8812_4F07_B329_2B0CB08926F7,
...
CREATE MEMORY TABLE PUBLIC.TESTPAPERSECTION(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_0C35A0AE_4D7B_48B9_9FC7_5B20C8BA07FC) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_0C35A0AE_4D7B_48B9_9FC7_5B20C8BA07FC,
...
CREATE MEMORY TABLE PUBLIC.QUESTION(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_0425E657_55B5_4534_9CFE_85A44F68D380) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_0425E657_55B5_4534_9CFE_85A44F68D380,
...
CREATE MEMORY TABLE PUBLIC.QUESTIONVERSIONASSET(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_F813B2FE_3495_4423_8C77_38F6E7FA5F3F) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_F813B2FE_3495_4423_8C77_38F6E7FA5F3F,
...
CREATE MEMORY TABLE PUBLIC.TERMSANDCONDITIONS(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_3FA2051E_2228_441D_A771_9CF18D23C046) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_3FA2051E_2228_441D_A771_9CF18D23C046,
...
CREATE MEMORY TABLE PUBLIC.EXAM(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_0372C160_CDAC_4333_8909_DD5D8A48712E) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_0372C160_CDAC_4333_8909_DD5D8A48712E,
...
CREATE MEMORY TABLE PUBLIC.TESTDAYENTRY(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_356D42DC_0279_4D80_9870_37E8B8D559FE) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_356D42DC_0279_4D80_9870_37E8B8D559FE,
...
CREATE MEMORY TABLE PUBLIC.CANDIDATEMODULE(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_644AC045_2539_4620_89B5_84BB1CD096E4) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_644AC045_2539_4620_89B5_84BB1CD096E4,
    MODULEID INT,
    CANDIDATEID INT
);      
...
CREATE MEMORY TABLE PUBLIC.MARK(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_8B39580F_67AB_4929_B916_3BA141DC455C) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_8B39580F_67AB_4929_B916_3BA141DC455C,
    MARKERID VARCHAR(36),
...
CREATE MEMORY TABLE PUBLIC.ANSWERASSET(
    _ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_8E936F15_72BC_4135_A28B_E6A5953DADE6) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_8E936F15_72BC_4135_A28B_E6A5953DADE6,
    QUESTIONID INT NOT NULL,
    QUESTIONVERSIONNUMBER INT NOT NULL,
    TESTDAYENTRYID INT NOT NULL,
    REFERENCENAME VARCHAR(150),
