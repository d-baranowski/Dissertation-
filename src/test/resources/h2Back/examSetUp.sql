...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_C606C0A2_6C49_4DE1_961A_0C19BC6EA4B0 START WITH 3 BELONGS_TO_TABLE;    
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_8B1D8E19_6A20_45EB_98E8_DB4A502AB422 START WITH 9 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_8CAF5729_DCF1_4FEB_9BD2_A0B92406D3EB START WITH 3 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_06DB375B_61CC_4807_BD34_3F7EA790B30B START WITH 5 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A3916F5D_3430_4890_BD43_ECC4AD0EB678 START WITH 54 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_64F30BC7_6406_41A9_B571_D7F8917E178A START WITH 6 BELONGS_TO_TABLE;    
...
(2, '27/04/2017', '04:34', '05:34', '06:04', 'Sample Location');             
...
(1, 1, 'CREATED', NULL, NULL, 2, 'eEYxV', 'STep6'),
(2, 2, 'CREATED', NULL, NULL, 2, 'zxcFi', 'Bl9Xu'),
(3, 3, 'CREATED', NULL, NULL, 2, 'adVvC', 'b1Izl'),
(4, 4, 'CREATED', NULL, NULL, 2, 'EXlxz', 'J7Wxl'),
(5, 5, 'CREATED', NULL, NULL, 2, '5vOuw', 'iBMem');        
