...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_356D42DC_0279_4D80_9870_37E8B8D559FE START WITH 6 BELONGS_TO_TABLE;    
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_0C35A0AE_4D7B_48B9_9FC7_5B20C8BA07FC START WITH 9 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_B012A917_8F5D_431E_AFEF_22651AAF595E START WITH 3 BELONGS_TO_TABLE;    
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_25EBE862_8812_4F07_B329_2B0CB08926F7 START WITH 5 BELONGS_TO_TABLE;    
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_0372C160_CDAC_4333_8909_DD5D8A48712E START WITH 3 BELONGS_TO_TABLE;    
...
(2, '25/04/2017', '01:41', '02:41', '03:11', 'Sample Location');             
...
(1, 1, 'CREATED', NULL, NULL, 2, 'WXFkT', 'O7QiE'),
(2, 2, 'CREATED', NULL, NULL, 2, 'mqrkq', '9hcmv'),
(3, 3, 'CREATED', NULL, NULL, 2, 'fhFsM', 'Lz7Z7'),
(4, 4, 'CREATED', NULL, NULL, 2, 'bSpMV', 'bX5HA'),
(5, 5, 'CREATED', NULL, NULL, 2, '1Azia', 'hTB2p');        
