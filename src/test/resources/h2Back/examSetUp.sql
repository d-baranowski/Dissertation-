...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_89DC0C70_58A6_453F_AEA7_5074C71CC195 START WITH 5 BELONGS_TO_TABLE;    
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_5617ECD6_6300_4CA1_8BFC_1D996750B77A START WITH 3 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_637568E0_AC6A_4C0B_9DCE_1EEC61C112C4 START WITH 9 BELONGS_TO_TABLE;    
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_78AA6136_52F0_4E60_A85C_689BF90056FD START WITH 6 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_892D48FB_8E28_40F2_BD58_D9A8485128D0 START WITH 3 BELONGS_TO_TABLE;    
...
(2, '27/04/2017', '22:51', '23:51', '00:21', 'Sample Location');             
...
(1, 1, 'CREATED', NULL, NULL, 2, 'b2aXH', 'M76DD'),
(2, 2, 'CREATED', NULL, NULL, 2, '9u3uY', 'gtnAu'),
(3, 3, 'CREATED', NULL, NULL, 2, 'piiyI', 'Bz9yF'),
(4, 4, 'CREATED', NULL, NULL, 2, '2Cbvx', '0Ftpy'),
(5, 5, 'CREATED', NULL, NULL, 2, '9yV5I', 'eAJdy');        
